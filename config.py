...
ADMINS = int(os.environ.get("ADMINS", "8301160173"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://ONeX_db_user:onexvartikuu142062@cluster0.ga3zort.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
